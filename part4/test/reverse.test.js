...
describe('total', () => {
    ...
    const multiple =[ {
      ...
      test("when you have multiple like of",()=>{
        const result = totalLikes(multiple)
        assert.strictEqual(result,36)
      })
  });

  describe('favorite blog of all', ()=>{
    test("my favorite is one with most votes",()=>{
        const blogs = [
            {
              _id: "5a422a851b54a676234d17f7",
              title: "React patterns",
  ...
  describe('active author',()=>{
    test('the active author',()=>{
      const blogs = [
        {
          _id: "5a422a851b54a676234d17f7",
          title: "React patterns",
      ...
      const activeAuthor = mostBlogs(blogs)
